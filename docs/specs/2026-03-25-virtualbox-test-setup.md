...
**방법 A: Enterprise 평가판 (90일 무료, 제품키 불필요)**

1. https://www.microsoft.com/en-us/evalcenter/evaluate-windows-10-enterprise 접속
2. **"Download the ISO"** 클릭
3. 양식 작성 (이름, 이메일 - 아무거나 입력 가능)
4. **"ISO - Enterprise"** 선택
5. **언어: "Korean"** 선택 (한글 Windows 테스트용)
6. **"64-bit"** 선택
7. 다운로드 시작 (약 5GB)

**방법 B: 일반 Windows 10 ISO**
...
4. 제품키:
   - 평가판 ISO: 자동으로 입력됨
   - 일반 ISO: **"제품 키가 없습니다"** 클릭 → **Windows 10/11 Pro** 선택
